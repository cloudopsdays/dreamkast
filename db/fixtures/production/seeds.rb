...
TalkCategory.seed(
  { id: 1,  conference_id: 1, name: "AI/ML"},
  { id: 2,  conference_id: 1, name: "Automation"},
  { id: 3,  conference_id: 1, name: "CI/CD"},
  { id: 4,  conference_id: 1, name: "Dev/Ops"},
  { id: 5,  conference_id: 1, name: "Infra as Code(IaC)"},
  { id: 6,  conference_id: 1, name: "Job Management"},
  { id: 7,  conference_id: 1, name: "MSP"},
  { id: 8,  conference_id: 1, name: "MicroService"},
  { id: 9,  conference_id: 1, name: "Monitoring/Logging/Tracing"},
  { id: 10, conference_id: 1, name: "Multi Cloud/Hybrid Cloud"},
  { id: 11, conference_id: 1, name: "No-Ops"},
  { id: 12, conference_id: 1, name: "Performance Tuning"},
  { id: 13, conference_id: 1, name: "SRE"},
  { id: 14, conference_id: 1, name: "Security"},
  { id: 15, conference_id: 1, name: "Server Infrastructure"},
  { id: 16, conference_id: 1, name: "Test(Chaos Engineering)"},
  { id: 17, conference_id: 1, name: "Troubleshooting"},
  { id: 18, conference_id: 1, name: "アジャイル開発"},
...
Sponsor.seed(
  ...
  {
    id: 2,
    name: "F5ネットワークスジャパン合同会社／NGINX事業部",
    abbr: "f5",
    conference_id: 1,
